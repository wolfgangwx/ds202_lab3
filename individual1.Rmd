...
# Explore the dataset
library (ggplot2)
# Check the distribution of variable: HAPPY
ggplot (HAPPY, aes(x=HAPPY, fill= HAPPY)) + geom_bar()  

# Check the distribution of variable: AGE
ggplot (HAPPY, aes(x=AGE)) + geom_histogram (position = "stack" , binwidth = .5)

# Check the distribution of variable HEALTH: 
ggplot (HAPPY, aes(x=HEALTH, fill=HEALTH)) + geom_bar() 
