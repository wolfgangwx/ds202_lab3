...
# Relationship between HAPPY to HEALTH
ggplot(data = HAPPY)  + 
  geom_mosaic(aes(x = product(HAPPY), fill=HEALTH)) + ylab ("HEALTH") + xlab ("HAPPY") + coord_flip()
  
# Relationship between HAPPY to WTSSALL
ggplot(HAPPY, aes(x=HAPPY,y=WTSSALL)) + geom_boxplot()

# Relationship between HAPPY to DEGREE
